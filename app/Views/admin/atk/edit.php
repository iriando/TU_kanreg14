...
<form action="<?= base_url('/atk/update/' . $atk->id) ?>" method="post">
    <?= csrf_field() ?>

    <div class="mb-3">
        <label for="kode_barang" class="form-label">Kode Barang</label>
        <input type="text" name="kode_barang" id="kode_barang"
               value="<?= old('kode_barang', $atk->kode_barang) ?>"
    ...
    <div class="mb-3">
        ...
        <input type="text" name="nama_barang" id="nama_barang"
               value="<?= old('nama_barang', $atk->nama_barang) ?>"
