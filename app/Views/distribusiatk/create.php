...
<div class="card card-primary">
    <div class="card-header">
        <h3 class="card-title">Daftar Distribusi ATK/ATRK</h3>
    </div>
    <div class="card-body">
        <form action="<?= site_url('distribusiatk/store') ?>" method="post">
            ...
            <div id="atk-wrapper">
                <div class="form-row align-items-end atk-item mb-2">
                    <div class="col-md-6">
                        <label>Barang</label>
                        <select name="kode_barang[]" class="form-control" required>
                            <option value="">-- Pilih Barang --</option>
                            <?php foreach($atk as $o): ?>
            ...
            <div class="mb-3">
                <button type="button" id="add-atk" class="btn btn-success btn-sm">+ Tambah</button>
            </div>
...
document.addEventListener("DOMContentLoaded", function() {
    const wrapper = document.getElementById("atk-wrapper");
    const addBtn = document.getElementById("add-atk");

    addBtn.addEventListener("click", function() {
        let firstItem = wrapper.querySelector(".atk-item");
